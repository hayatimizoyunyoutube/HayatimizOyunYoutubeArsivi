...
function maintenanceZiyaretçi(){
  ...
  const plannedFallback=[
    ...
    {version:'v3.0.0',title:'Ana Açılış',summary:'Hayatımız Oyun public arşiv sitesi açılış sürümüne taşınacak.'}
  ];
