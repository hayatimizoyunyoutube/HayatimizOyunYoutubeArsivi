...
function maintenanceZiyaretçi(){
  ...
  const plannedFallback=[
    {version:'v2.2.9',title:'3.0 Açılış Öncesi Public Cila',summary:'Ana sayfa, arşiv, seriler, takvim ve izleme alanları açılışa hazırlanacak.'},
    {version:'v2.3.0',title:'3.0 Açılış Stabilite Kontrolü',summary:'Tüm sayfalar, Supabase kayıtları, bakım ve ban akışı büyük açılış öncesi test edilecek.'},
    {version:'v4.0.0',title:'Ana Açılış',summary:'Hayatımız Oyun public arşiv sitesi açılış sürümüne taşınacak.'}
  ];
