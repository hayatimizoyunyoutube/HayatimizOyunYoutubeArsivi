...
const VERSION = 'v2.2.0 FIX 11 - 4 Kolon Arşiv, Profesyonel Form ve Bakım';
...
async function submitBugReportFix8(e){
...
function v221ArchiveView(){ return localStorage.getItem(V221_VIEW_KEY) || state.gameViewMode || 'compact'; }
...
const v221PublicHighlightsOld = publicHighlights;
publicHighlights = function(){ return v221PublicHighlightsOld() + v221ViewTools(); };
