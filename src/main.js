...
const FIX_NAME = 'v2.2.1 - Sürüm Senkronizasyonu ve Premium Bakım Merkezi';
...
const DEFAULT_NOTES = [
  {id:'v221-bakim-supabase-ban-guvenligi',version:'v2.2.1',title:'🛠️ Bakım Ekranı, Supabase Kalıcılık ve Ban Güvenliği',summary:'Bakım modu animasyonlu ziyaretçi ekranına taşındı. Oyun, takvim, not, kullanıcı ve bakım kayıtlarında Supabase kalıcılığı güçlendirildi. Yeni fix ve güncellemelerde veriler sıfırlanmasın diye schema mantığı korumalı hale getirildi. Banlı kullanıcılar siteye ulaşamaz ve Discord iletişim bağlantısı görür.',status:'Tamamlandı'},
...
function maintenanceZiyaretçi(){
  ...
  return `<main class="maintenanceZiyaretçi proMaintenance v221Maintenance bondFirstLightMaintenance"><section class="maintenanceCard proMaintenanceCard v221MaintenanceCard"><div class="bondSky"><span></span><span></span><span></span></div><div class="bondScan"></div><div class="maintenanceOrbit bondOrbit"><span></span><span></span><span></span></div><div class="maintenanceGlow bondGlow"></div><span class="badge amber">🎬 v2.2.1 • Premium Bakım Modu</span><h1>007 First Light Esintili Bakım</h1><p>${esc(m.message || 'Hayatımız Oyun arşivi daha güvenli, daha hızlı ve daha stabil hale getiriliyor.')}</p><div class="maintenanceProgress bondProgress"><i><span style="width:${pct}%"></span></i><b>%${pct}</b></div><div class="maintenanceInfoGrid"><article><b>🕶️ Operasyon</b><span>Site bakım modunda.</span></article><article><b>💾 Supabase</b><span>Veriler korunur, sıfırlanmaz.</span></article><article><b>⏰ Tahmini Açılış</b><span>${esc(m.eta || 'Yakında güncellenecek.')}</span></article></div><div class="maintenancePublicActions"><button class="btn ghost" type="button" data-maintenance-retry>🔄 Tekrar Kontrol Et</button></div><small class="maintenanceNote">Bakım kapanınca site otomatik normal ekrana döner. Yetkili hesaplar yönetim için giriş yapabilir.</small></section></main>`;
}
