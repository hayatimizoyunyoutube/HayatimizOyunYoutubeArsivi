...
const VERSION = 'v2.2.3 FIX 4 - Seri Sıralama ve AI Özellik Akışı';
...
/* v2.2.3 FIX 3 - AI Özellik Ekle ayrı sayfa + oyun ekleme stabil fix */
const V223_FIX3_LABEL = 'v2.2.3 FIX 3 - AI Ayrı Buton ve Oyun Ekle Stabil';
...
/* v2.2.3 FIX 4 - Seri sıralama eski üst buton düzeni + AI özellik önerileri 10'lu akış */
