...
const VERSION = 'v2.1.3 Storage + Güncelleme Notları + Seri Fix';
...
function showBootError(error){
  const root = document.getElementById('root'); if(!root) return; root.dataset.mounted='1'; if(window.__HAYATIMIZ_BOOT_TIMER__) window.clearTimeout(window.__HAYATIMIZ_BOOT_TIMER__);
