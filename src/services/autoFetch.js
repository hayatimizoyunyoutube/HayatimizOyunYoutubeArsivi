...
export const fallbackConfig = { heroText:'v2.1.1 Fix 4 güvenli yedek veriyle açıldı. Vercel ENV uyarıları düzeltildi, admin buton fixleri korundu.', sources:[{name:'Local JSON',enabled:true,priority:1}], syncSettings:{safeFallback:true,testCenter:true,errorReports:true,apiStatusPanel:true,consoleGuard:true}, homepageWidgets:['test merkezi','hata raporlama'], theme:'cinematic-red' };
...
export const fallbackNotifications = [{ level:'bilgi', title:'v2.1.1 Fix 4 hazır', text:'Vercel ENV yanlış uyarıları temizlendi; local JSON ile arayüz çalışır.', time:'Şimdi' }];
