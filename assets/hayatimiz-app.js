...
const FIX_NAME = 'v2.2.7 - Sürüm Senkronizasyonu ve Mobil Deploy Güvenliği';
...
const DEFAULT_NOTES = [
  ...
  {id:'plan-v226',version:'v2.2.7',title:'📱 Mobil Menü ve Responsive Cila',summary:'Üst menü, yönetim menüsü, büyük kartlar ve public/admin sayfaları mobilde daha kompakt hale getirilecek.',status:'Planlandı'},
  ...
  {id:"plan-v226-dashboard",version:"v2.2.7",title:"📊 Admin Dashboard İstatistikleri",summary:"Yönetim panelinde arşivin genel durumunu daha güçlü göstermek. Toplam oyun, seri, bölüm, kullanıcı ve güncelleme notu metrikleri güçlendirilecek.",status:"Planlandı"},
...
function maintenanceZiyaretçi(){
  ...
  const plannedFallback=[
    {version:'v2.2.7',title:'Mobil menü ve responsive cila',summary:'Üst menü, yönetim menüsü ve kartlar mobilde daha kompakt çalışacak.'},
