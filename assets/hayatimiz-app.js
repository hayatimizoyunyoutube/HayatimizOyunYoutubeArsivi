...
const DEFAULT_NOTES = [
  {id:'v402-youtube-episodes-reset-fix',version:'v4.0.5',title:'✅ YouTube Episodes Reset Fix',summary:'Supabase games + episodes schema yenilendi; playlistItems.list ile çekilen gerçek videolar Episodes tablosuna yazılır.',status:'Tamamlandı'},
  {id:'v401-ana-acilis-profesyonel-final',version:'v4.0.5',title:'🎉 Ana Açılış Sürümü',summary:'Hayatımız Oyun public arşiv sitesi profesyonel ana sayfa, arşiv, seriler, yayın takvimi, profil, favoriler, başarımlar, veri sağlığı, bakım/ban güvenliği ve yönetim paneliyle yayına hazır hale getirildi.',status:'Tamamlandı'},
  {id:'v401-profesyonel-tasarim-final',version:'v4.0.5 FIX',title:'🎨 Profesyonel Tasarım Finali',summary:'Ana sayfa, arşiv kartları, seri merkezi, kategori/koleksiyon sayfaları, profil merkezi ve yönetim paneli daha modern, kompakt ve mobil uyumlu hale getirildi.',status:'Tamamlandı'},
  {id:'v401-versiyon-senkron-final',version:'v4.0.5 FIX',title:'🏷️ Sürüm Senkronizasyonu',summary:'Site sürümü, Vercel etiketi, schema.sql Results çıktısı, status, health, README ve güncelleme notları v4.0.5 olarak eşitlendi. Eski aktif sürüm etiketleri pasifleştirildi.',status:'Tamamlandı'},
  {id:'v401-veri-guvenligi-final',version:'v4.0.5 FIX',title:'🛡️ Veri Güvenliği ve Yönetim',summary:'Oyunlar, bölümler, kullanıcılar, favoriler, takip, başarımlar ve takvim kayıtları için mevcut veri koruma mantığı korunur. Bakım modu açılışta kapalıdır.',status:'Tamamlandı'},
  {id:'plan-v401-acilis-sonrasi-stabilite',version:'v4.0.5',title:'🛠️ Açılış Sonrası Stabilite',summary:'Canlı kullanımdan sonra küçük görünüm, veri ve mobil düzeltmeleri yapılacak.',status:'Planlandı'},
