...
const FIX_NAME = 'v2.2.9 - Public Açılış Cilası';
...
const DEFAULT_NOTES = [
  {id:'fix-v228-bakim-guncelleme-notlari-guncel-cekim',version:'v2.2.9 FIX',title:'🛠️ Bakım Modu Güncelleme Notları Fix',summary:'Bakım ekranındaki eklenenler ve sonraki güncellemeler artık güncel notlardan çekilir; eski planlar üstte kalmaz.',status:'Tamamlandı'},
  {id:'v228-3-0-acilis-plani-bakim-ilerleme',version:'v2.2.9',title:'🚀 Public Açılış Cilası',summary:'Tüm planlar v4.0.0 ana açılış hedefine göre düzenlendi. Bakım modu ziyaretçilere otomatik ilerleme, güncel eklenenler ve gelecek planları gösterir.',status:'Tamamlandı'},
  ...
  {id:'plan-v300-ana-acilis',version:'v4.0.0',title:'🎉 Ana Açılış Sürümü',summary:'Public arşiv, yayın takvimi, seri merkezi, bakım/ban güvenliği ve yönetim paneli yayın için son hale getirilecek.',status:'Planlandı'},
