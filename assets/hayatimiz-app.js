...
const FIX_NAME = 'v2.3.1 - Kullanıcı Profil Sistemi';
...
const DEFAULT_NOTES = [
  {id:'fix-v230-guncelleme-isleme-senkron',version:'v2.3.0 FIX',title:'🧾 Güncelleme İşleme ve Sürüm Senkron Fix',summary:'Deploy sonrası eski notların görünmesi engellendi. Aktif sürüm, bakım ekranı, status, yönetim paneli ve güncelleme notları v2.3.0 olarak senkron çalışır.',status:'Tamamlandı'},
  ...
  {id:'plan-v232-favoriler-takip-sistemi',version:'v2.3.2',title:'⭐ Favoriler ve Takip Sistemi',summary:'Kullanıcılar favori oyun/seri ekleyebilecek, takip ettiği serilerin sıradaki bölümlerini görebilecek.',status:'Planlandı'},
