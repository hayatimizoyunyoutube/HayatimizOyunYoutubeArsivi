...
const FIX_NAME = 'v2.1.9 - Profesyonel Yönetim Merkezi ve Takvim Sistemi';
...
const DEFAULT_NOTES = [
  {id:'v219-profesyonel-yonetim-merkezi-takvim',version:'v2.1.9',title:'🛡️ Profesyonel Yönetim Merkezi ve Takvim Sistemi',summary:'Yönetim paneli yeni sürüm olarak toparlandı. Dashboard kartları, hızlı işlemler, Supabase veri sağlığı, kullanıcı/yetki alanları ve yayın takvimi daha stabil hale getirildi. Yayın takvimi artık gün kutulu gerçek takvim görünümüyle çalışır.',status:'Tamamlandı'},
  {id:'plan-v220',version:'v2.2.0',title:'🧩 Supabase Veri Sağlığı ve Yedek Planı',summary:'Sıradaki ana plan: Supabase tabloları, yedekleme, veri sağlık kontrolleri, admin logları ve güvenli aktarım sistemi güçlendirilecek.',status:'Planlandı'},
  {id:'fix-v218-ana-sayfa-bos-tasarim-kesin',version:'v2.1.8 FIX',title:'🏠 Ana Sayfa Boş Arşiv Tasarımı Kesin Fix',summary:'Yeni sürüm yapılmadan oyun ekli değilken ana sayfanın güvenli hata ekranına düşmesi engellendi. Öne çıkan oyun yoksa profesyonel boş arşiv vitrini gösterilir; Alan Wake/demo oyun otomatik basılmaz.',status:'Tamamlandı'},
  {id:'fix-v218-ana-sayfa-bos-arsiv-vercel-etiket',version:'v2.1.8 FIX',title:'🏠 Ana Sayfa Boş Arşiv ve Vercel Etiket Fix',summary:'Yeni sürüm yapılmadan oyun ekli değilken ana sayfada örnek/yanlış oyun görünmesi engellendi. Supabase oyun tablosu boşsa site boş arşiv durumunu korur. Vercel deploy/BAT/marker metinleri v2.1.8 FIX olarak güncellendi.',status:'Tamamlandı'},
  {id:'fix-v218-site-hata-guvenli-acilis',version:'v2.1.8 FIX',title:'🛡️ Site Hatası ve Güvenli Açılış Fix',summary:'Yeni sürüm yapılmadan v2.1.8 açılış hatası için güvenli render, bağımsız hata ekranı, bozuk/şişmiş yerel depolama onarımı ve sağlam boot koruması eklendi. Ana sayfa hata verse bile site boş kalmaz.',status:'Tamamlandı'},
  {id:'v218-yetki-paneli-kullanici-yonetimi',version:'v2.1.8',title:'👑 Profesyonel Yönetim Merkezi ve Takvim Sistemi',summary:'Kullanıcılar ve Yetkiler ekranı profesyonel hale getirildi. Kayıtlı kullanıcılar, Supabase yetki kayıtları, rol özetleri, arama/filtreleme, Türkçe rol seçimi, kullanıcı ekleme ve yetki kaydetme akışı güçlendirildi.',status:'Tamamlandı'},
  {id:'v217-kullanici-profili-izleme-gecmisi',version:'v2.1.7',title:'👤 Kullanıcı Profili ve İzleme Geçmişi',summary:'Profil sayfası profesyonel hale getirildi. Kullanıcı adı, rol, kayıt tarihi, izleme özeti, devam et kartları, son izlenenler ve yerel/Supabase güvenli izleme geçmişi akışı eklendi.',status:'Tamamlandı'},
  {id:'v216-seri-yonetimi-gelismis-siralama',version:'v2.1.6',title:'🎬 Seri Yönetimi Gelişmiş Sıralama',summary:'Seri yönetimi daha profesyonel hale getirildi. Seri içindeki oyunları seçme/çıkarma, sürükle-bırak, sayı ile sıra verme, hızlı A-Z/süreç sıralama, tüm seriyi izleme önizlemesi ve Supabase kalıcı kayıt akışı güçlendirildi.',status:'Tamamlandı'},
  {id:'fix-v215-seri-bakim-kesin',version:'v2.1.5 FIX',title:'🛠️ Seri Adı ve Bakım Modu Kesin Fix',summary:'Yeni sürüm yapılmadan A Plague Tale oyunlarının Avatar gibi alakasız seriye bağlanması engellendi. Bakım modu açıkken Supabase yenile düğmesinin eski kapalı değerle bakım modunu kapatması önlendi.',status:'Tamamlandı'},
  {id:"fix-v215-kullanicilar-yetkiler-paneli",version:"v2.1.5 FIX",title:"👥 Kullanıcılar ve Yetkiler Paneli Fix",summary:"Yeni sürüm yapılmadan yönetim panelindeki 'Yetkililer' görünen alanı 'Kullanıcılar ve Yetkiler' olarak düzeltildi. Kayıtlı kullanıcı listesi, kullanıcı ekleme ve yetki verme aynı panelde daha belirgin hale getirildi.",status:"Tamamlandı"},
  {id:"fix-v215-seri-hikaye-takvim-alfabetik-rehber",version:"v2.1.5 FIX",title:"🛠️ Seri Adı, Hikaye, Takvim, Alfabetik ve Yetkili Rehberi Fix",summary:"Yeni sürüm yapılmadan seri adı okuma ve profesyonel hikaye üretimi güçlendirildi. Yetkili Rehberi yönetim paneline eklendi; ana sayfaya takvim görünümü taşındı. Oyun arşivi ve seriler içinde A Harfinde Başlayan Oyunlar / harfe git düzeni iyileştirildi.",status:"Tamamlandı"},
  {id:"v215-oyun-detay-siteden-izleme",version:"v2.1.5",title:"▶️ Oyun Detay ve Siteden İzleme Geliştirme",summary:"Oyun detay sayfası profesyonel kapak/banner, hikaye, bölüm ilerlemesi, etiketler ve izleme bağlantılarıyla güçlendirildi. Siteden izleme ekranına sıradaki bölüm, bölüm ilerleme paneli, güvenli oynatıcı uyarısı ve detay sayfası bağlantıları eklendi.",status:"Tamamlandı"},
  {id:"fix-v214-ana-sayfa-acilis-asset",version:"v2.1.4 FIX",title:"🏠 Ana Sayfa Açılış ve Asset Fix",summary:"Yeni sürüm yapılmadan ana sayfanın açılmamasına neden olan eski v2.1.3 JS/CSS asset referansları düzeltildi. index.html artık mevcut v2.1.4 uygulama dosyalarını yükler; build kontrolü eski asset referansı kalırsa hata verir.",status:"Tamamlandı"},
  {id:"v214-profesyonel-ana-sayfa-final-cila",version:"v2.1.4",title:"🏠 Profesyonel Ana Sayfa Final Cila",summary:"Ana sayfa yayıncı/video arşivi havasına daha yakın hale getirildi. Büyük sinematik hero, akıllı arama, öne çıkan oyun, devam eden seriler, son eklenenler, hızlı erişimler ve yayın öncesi güven panelleri daha profesyonel yerleşime alındı.",status:"Tamamlandı"},
  {id:"v213-supabase-veri-fix-admin-guclendirme",version:"v2.1.3",title:"🛠️ Supabase Veri Fix ve Admin Güçlendirme",summary:"Supabase oyun ekle/düzenle/sil, kullanıcı yetkileri, admin veri sağlığı ve güvenli yenileme akışı güçlendirildi. API/ENV eksikse site yerel güvenli moda düşer; boş ekran oluşmaz. Schema güvenli modda güncellendi, mevcut veriler silinmez.",status:"Tamamlandı"},
  {id:"fix-v212-schema-supabase-yetki-verme",version:"v2.1.2 FIX",title:"🗄️ Supabase Schema Yetki Verme Fix",summary:"Yeni sürüm yapılmadan schema.sql güvenli güncellendi. Supabase Table Editor içindeki site_authority_assignments tablosundan veya SQL Editor içinde set_site_user_role fonksiyonuyla Kurucu, Moderatör, İçerik Editörü, Üye ve Banlı yetkisi verilebilir. DROP TABLE yok, mevcut veriler silinmez.",status:"Tamamlandı"},
  {id:"fix-v212-ust-menu-sabit-degil-turkce-yetki-tablosu",version:"v2.1.2 FIX",title:"🧭 Üst Menü Takip Etmeme ve Türkçe Yetki Tablosu Fix",summary:"Yeni sürüm yapılmadan üst menünün sayfayı aşağı kaydırınca kullanıcıyla birlikte gelmesi engellendi. Yönetim panelindeki kullanıcı/yetki tablosu Türkçe/emojili rollere alındı; Kurucu, Moderatör, İçerik Editörü, Üye ve Banlı rolleri tablodan eklenip kaydedilebilir hale getirildi.",status:"Tamamlandı"},
  {id:"fix-v212-ust-menu-tek-satir-tasma",version:"v2.1.2 FIX",title:"🧭 Üst Menü Tek Satır Taşma Fix",summary:"Yeni sürüm yapılmadan üst menü sıkıştırıldı ve tek satırda kalacak şekilde düzenlendi. Ana sayfa, Arşiv, Koleksiyonlar, Seriler, Site Durumu, Site Rehberi, Yetkili Rehberi, Yönetim Paneli, rol, profil ve çıkış butonları alta taşmadan aynı satırda korunur.",status:"Tamamlandı"},
...
function normalizeGame(g,i){
  ...
  return {
    ...
    releaseDate: src.releaseDate || src.release_date || src.released || src.release || '',
...
function normalizeRemoteGame(g,i=0){
  return normalizeGame({
    ...
    cover:g.cover_url || g.cover || g.background_image, banner:g.banner_url || g.banner || g.background_image, releaseDate:g.release_date || g.releaseDate || g.released,
...
async function refreshGamesFromSupabase({force=false}={}){
  ...
  try{
    ...
    if(Array.isArray(data.games)){ saveGames(remote); localStorage.setItem(STORAGE.lastRemoteSync,new Date().toISOString()); }
...
function saveMaintenance(v){
  const cfg = sanitizeMaintenance({...v, enabled: parseMaintenanceEnabled(v?.enabled), percent: Math.max(0, Math.min(100, Number(v?.percent||0))), managedBy:'v2.1.1-supabase-runtime', updatedAt:new Date().toISOString()});
...
function roleOptionsHtml(currentRole, email=''){
  ...
  const roles=[['kurucu','👑 Kurucu'],['moderator','🛡️ Moderatör'],['editor','✍️ İçerik Editörü'],['user','👤 Üye'],['banned','🚫 Banlı']];
...
function userTopbar(){
  ...
  return `<header class="topBar proStickyTop topOnlyBar"><div class="topIdentity"><b>🎮 Hayatımız Oyun</b><small>${VERSION} • 👑 Yetki Paneli + Kullanıcı Yönetimi</small></div><nav class="topQuickNav fullTopNav">${publicLinks.map(([href,label])=>`<a class="${active(href)?'active':''}" href="${href}">${label}</a>`).join('')}</nav>${isYönetim()?'<a class="topAdminOpen" href="/yonetim">🛡️ Yönetim Paneli</a>':''}${auth}</header>`;
}
...
function adminDock(){
  ...
  const items=[['/yonetim','🛡️ Panel'],['/yonetim/oyun-ekle','➕ Oyun Ekle'],['/yonetim/mevcut-oyunlar','🎮 Oyunlar'],['/yonetim/seriler','🎬 Seriler'],['/yonetim/bolum-takibi','▶️ Bölümler'],['/yonetim/yayin-takvimi','📅 Takvim'],['/yonetim/guncelleme-notlari','📝 Notlar'],['/yonetim/bakim-modu','🛠️ Bakım'],['/yonetim/kullanicilar','👥 Kullanıcılar ve Yetkiler'],['/yetkili-rehberi','👑 Yetkili Rehberi']];
  return `<section class="adminDock proAdminDock"><div><b>🛡️ Yönetim Paneli</b><small>Kayıtlı kullanıcılar, yetki verme ve tüm yönetim araçları bu üst yönetim menüsünde.</small></div><nav>${items.map(([href,label])=>`<a class="${active(href)?'active':''}" href="${href}">${label}</a>`).join('')}</nav></section>`;
}
...
function calendarHomeBlock(events){
  ...
  return `<article class="homeCalendarCard"><div class="sectionHead compact"><div><h3>📅 Ana Sayfa Yayın Takvimi</h3><p>Yaklaşan yayınlar kart düzeninde gösterilir.</p></div><a class="miniBtn" href="/yayin-takvimi">📅 Tüm Takvim</a></div><div class="homeCalendarGrid">${rows.map(e=>{ const day=String(e.date||'Tarih').slice(-2)||'--'; const month=String(e.date||'').slice(5,7)||'--'; return `<div class="homeCalendarDay"><b>${esc(day)}</b><span>${esc(month)}</span><strong>${esc(e.title||'Yayın')}</strong><small>${esc(e.time||'20:00')} • ${esc(e.gameTitle||e.type||'Plan')}</small></div>`; }).join('')}</div></article>`;
}
...
function publicCalendarPage(){
  ...
  const listHtml=rows.length?`<section class="publicCalendarList panel"><div class="sectionHead compact"><div><h2>📌 Yaklaşan Yayınlar</h2><p>Tüm kayıtlar takvimin altında liste olarak da görünür.</p></div></div><div class="miniList">${rows.map(e=>`<article class="event"><span class="pill green">${esc(e.date||'Tarih yok')} • ${esc(e.time||'20:00')}</span><h3>${esc(e.title||'Yayın Planı')}</h3><p>${esc(e.gameTitle||'Genel yayın')} ${e.episodeNumber?`• ${esc(e.episodeNumber)}`:''}</p>${e.videoUrl?`<a class="miniBtn primary" href="${esc(e.videoUrl)}" target="_blank" rel="noreferrer">▶️ Video / Yayını Aç</a>`:''}</article>`).join('')}</div></section>`:'';
  return layout(`<section class="archiveHero calendarPublicHero"><div><span class="badge green">📅 ${VERSION} FIX • Public Yayın Takvimi</span><h1>📅 Yayın Takvimi</h1><p>Normal kullanıcılar ve ziyaretçiler yayınları artık liste gibi değil, ay bazlı gerçek takvim kutuları içinde takip eder.</p></div><div class="actions"><a class="btn primary" href="/ana-sayfa">🏠 Ana Sayfa</a><a class="btn secondary" href="/oyun-arsivi?sort=az">🎮 Arşiv</a>${isYönetim()?'<a class="btn secondary" href="/yonetim/yayin-takvimi">🛠️ Takvimi Yönet</a>':''}</div></section><section class="archiveStats"><article><b>${rows.length}</b><span>📅 Toplam Plan</span></article><article><b>${liveCount}</b><span>🔴 Canlı Yayın</span></article><article><b>${videoCount}</b><span>▶️ Video</span></article><article><b>${rows.length?monthTitle:'Takvim'}</b><span>🗓️ Ay Görünümü</span></article></section><section class="panel publicMonthCalendar"><div class="sectionHead compact"><div><h2>🗓️ ${esc(monthTitle)}</h2><p>${rows.length?'Yayınlar gün kutularına işlendi.':'Henüz yayın planı yok; yine de takvim görünümü boş ay olarak gösterilir.'}</p></div>${isYönetim()?'<a class="btn primary" href="/yonetim/yayin-takvimi">📅 Yayın Ekle</a>':''}</div><div class="publicCalendarWeek">${week.map(w=>`<b>${w}</b>`).join('')}</div><div class="publicMonthGrid">${cells.map(c=>c.empty?'<article class="publicMonthCell mutedCell"></article>':`<article class="publicMonthCell ${c.events.length?'hasEvent':''}"><strong>${c.day}</strong>${c.events.length?c.events.slice(0,3).map(e=>`<div class="publicTinyEvent"><span>${esc(e.time||'20:00')}</span><b>${esc(e.title||'Yayın')}</b><small>${esc(e.gameTitle||e.type||'Plan')}</small></div>`).join(''):'<em>Plan yok</em>'}${c.events.length>3?`<i>+${c.events.length-3} kayıt</i>`:''}</article>`).join('')}</div></section>${listHtml}`);
}
function home(){
...
function seriesPage(){
  ...
  const all=Array.from(model.series.entries()).map(([name,rows])=>[cleanSeriesName(name, rows[0]?.title)||name, orderedSeriesRows(sortGamesForView(rows, sort==='az'||sort==='za'||sort==='numeric'?sort:'series'))]).sort((a,b)=>{
...
function roleGuideMini(){
  return `<section class="roleMiniGuide v218RoleGuide"><article><b>👑 Kurucu</b><span>Tüm site, bakım modu, kullanıcı yetkileri ve veriler.</span></article><article><b>🛡️ Moderatör</b><span>Yönetim paneline girer; içerik düzenine yardım eder.</span></article><article><b>✍️ İçerik Editörü</b><span>Oyun, hikaye, bölüm ve arşiv içeriklerini düzenler.</span></article><article><b>👤 Üye</b><span>Public siteyi kullanır, yönetim alanına giremez.</span></article><article><b>🚫 Banlı</b><span>Erişimi kısıtlanmış kullanıcıdır.</span></article></section>`;
}
function usersPage(){ return adminOnly(()=>{ const all=localUserRows(); const filters=userFilterParams(); const rows=filterUsers(all, filters); return layout(`<section class="archiveHero userHero v218UserHero"><div><span class="badge green">👑 ${VERSION} • Yetki Paneli</span><h1>👥 Kullanıcılar ve Yetkiler</h1><p>Kayıtlı kullanıcıları, Supabase yetki kayıtlarını ve yerel yetki tablosunu tek profesyonel ekranda yönet. Roller tamamen Türkçe: Kurucu, Moderatör, İçerik Editörü, Üye ve Banlı.</p><div class="actions"><button class="btn secondary" type="button" data-refresh-users>🔄 Supabase’den Yenile</button><a class="btn secondary" href="/yetkili-rehberi">👑 Yetkili Rehberi</a></div></div><aside><b>💾 Kalıcı Yetki</b><span>Supabase varsa e-posta + rol kaydı sunucuya yazılır.</span><small>Schema: site_authority_assignments + site_users + audit kaydı</small></aside></section>${userStatsCards(all)}<section class="panel userAddPanel v218UserAdd"><h2>➕ Kullanıcı Ekle / Yetki Ver</h2><form class="userAddForm" data-user-add-form><label class="field">Ad / Görünen İsim<input class="input" name="displayName" placeholder="Örn: İçerik Editörü"></label><label class="field">E-posta<input class="input" name="email" type="email" required placeholder="ornek@mail.com"></label><label class="field">Yetki<select name="role">${roleOptionsHtml('user')}</select></label><button class="btn primary" type="submit">👑 Yetkiyi Kaydet</button></form><p class="muted">E-posta aynıysa kayıt güncellenir. Supabase aktifse yetki sunucuya, değilse yerel tabloya yazılır.</p></section><section class="panel userFilterPanel"><h2>🔎 Kullanıcı Ara / Filtrele</h2><form class="userFilterForm" data-user-filter-form><input class="input" name="user_q" value="${esc(filters.q)}" placeholder="E-posta, isim veya rol ara"><select class="input" name="user_role"><option ${selectedOption(filters.role,'Tümü')}>Tümü</option><option value="kurucu" ${selectedOption(filters.role,'kurucu')}>👑 Kurucu</option><option value="moderator" ${selectedOption(filters.role,'moderator')}>🛡️ Moderatör</option><option value="editor" ${selectedOption(filters.role,'editor')}>✍️ İçerik Editörü</option><option value="user" ${selectedOption(filters.role,'user')}>👤 Üye</option><option value="banned" ${selectedOption(filters.role,'banned')}>🚫 Banlı</option></select><button class="btn secondary" type="submit">Filtrele</button><a class="btn secondary" href="/yonetim/kullanicilar">Temizle</a></form></section>${roleGuideMini()}<section class="panel userTablePanel"><div class="sectionHead compact"><div><h2>👥 Kayıtlı Kullanıcılar</h2><p>${rows.length} kullanıcı gösteriliyor. Yeni açılan Supabase Auth hesapları otomatik çekilir. Yetkiyi seçip <b>Yetkiyi Kaydet</b> butonuna bas.</p></div></div><div class="userList userTable v218UserTable" data-user-list data-auto-users="1">${renderUserRows(rows)}</div></section>`); }); }
function renderUserRows(rows){
  const list=Array.isArray(rows)?rows:[]; if(!list.length) return '<div class="empty">Henüz kayıtlı kullanıcı görünmüyor. Yeni kayıt olunca veya üstteki formdan kullanıcı ekleyince burada listelenir.</div>';
  return list.map(u=>{ const email=String(u.email||''); const role=roleValue(u.role,email); const active=u.is_active!==false && role!=='banned'; const created=u.createdAt || u.created_at || u.updated_at || ''; return `<article class="userRow proUserRow v218UserRow" data-user-id="${esc(u.id||'')}" data-user-email="${esc(email)}" data-user-source="${esc(u.source||'Yerel')}"><div class="userAvatar">${esc((u.displayName||u.full_name||email||'?').slice(0,1).toLocaleUpperCase('tr'))}</div><div class="userCell"><b>${esc(u.displayName||u.full_name||email)}</b><small>${esc(email)} • ${esc(u.source||'Supabase/Yerel')} ${created?'• '+esc(String(created).slice(0,10)):''}</small></div><span class="roleChip roleChipTable role-${esc(role)}">${esc(roleLabel(role,email))}</span><select class="input roleSelect" data-role-select aria-label="Yetki seç">${roleOptionsHtml(role,email)}</select><span class="userState ${active?'ok':'blocked'}">${active?'✅ Aktif':'🚫 Kısıtlı'}</span><div class="userRowActions"><button class="miniBtn primary" data-user-role-save>💾 Yetkiyi Kaydet</button><button class="miniBtn danger" data-user-delete>🗑️ Sil</button></div></article>`; }).join('');
}
async function refreshUsersPanel(){
  ...
  try{
    ...
    const remote=(data.users||[]).map(u=>({id:u.id,email:u.email,displayName:u.full_name||u.displayName||u.email,role:u.role,is_active:u.is_active,source:u.source||'Supabase'}));
    const merged=[...remote];
...
function seriesManager(){ return adminOnly(()=>{
  ...
  const allRows=games.map((g,i)=>({...g, _seriesChecked:selectedIds.has(String(g.id)), _seriesOrder:Number(g.seriesOrder ?? g.sortOrder ?? i)}))
...
function bind(){
  document.body.addEventListener('click', e=>{
    ...
    const userAdd=e.target.closest('[data-user-add-form]'); if(userAdd){ e.preventDefault(); const fd=new FormData(userAdd); const email=String(fd.get('email')||'').trim().toLowerCase(); const displayName=String(fd.get('displayName')||'').trim() || email; const role=roleValue(fd.get('role')||'user', email); if(!email){ toast('E-posta yazmalısın.'); return; } let users=loadUsers().filter(u=>String(u.email||'').toLowerCase()!==email); const user={id:'local-'+Date.now(),email,displayName,role,is_active:role!=='banned',source:'Yerel Tablo',createdAt:new Date().toISOString()}; users.unshift(user); saveUsers(users); userAdd.reset(); toast(`${displayName} tabloya ${roleLabel(role,email)} olarak eklendi.`); apiJson('user-role-set',{adminToken:sessionToken(),email,displayName,role}).then(()=>refreshUsersPanel()).then(()=>toast('Yetki Supabase tablosuna da kaydedildi.')).catch(err=>{ console.warn('Supabase yetki kaydı yerel modda kaldı:', err.message); render(); }); return; }
    if(e.target.closest('[data-refresh-users]')){ e.preventDefault(); refreshUsersPanel(); return; }
    const roleSave=e.target.closest('[data-user-role-save]'); if(roleSave){ const row=roleSave.closest('[data-user-id]'); const id=row?.dataset?.userId||''; const email=String(row?.dataset?.userEmail||row?.querySelector('small')?.textContent?.split('•')?.[0]?.trim()||'').toLowerCase(); const role=roleValue(row?.querySelector('[data-role-select]')?.value||'user', email); const rowSource=String(row?.dataset?.userSource||''); const isRemoteUser=rowSource.includes('Supabase') || rowSource.includes('site_users') || rowSource.includes('Yetki'); if(!isRemoteUser || id.startsWith('local') || id==='current-session'){ let users=loadUsers(); if(!users.some(u=>String(u.email).toLowerCase()===email)) users.push({id:id||('local-'+Date.now()),email,displayName:email,role,source:'Yerel Tablo'}); users=users.map(u=>String(u.id)===id||String(u.email).toLowerCase()===email?{...u,role,is_active:role!=='banned'}:u); saveUsers(users); const session=currentUser(); if(session && String(session.email).toLowerCase()===email){ localStorage.setItem(STORAGE.session, JSON.stringify({...session,role})); } toast(`Yetki Türkçe tabloda ${roleLabel(role,email)} olarak kaydedildi.`); render(); } else { apiJson('user-role-set',{adminToken:sessionToken(),userId:id,email,displayName:row?.querySelector('b')?.textContent||email,role}).then(()=>refreshUsersPanel()).then(()=>toast(`Supabase yetkisi ${roleLabel(role,email)} olarak güncellendi.`)).catch(err=>toast('Yetki güncellenemedi: '+err.message)); } return; }
    const userDel=e.target.closest('[data-user-delete]'); if(userDel){ const row=userDel.closest('[data-user-id]'); const id=row?.dataset?.userId||''; if(!confirm('Kullanıcıyı silmek istiyor musun?')) return; const rowSource=String(row?.dataset?.userSource||''); const isRemoteUser=rowSource.includes('Supabase') || rowSource.includes('site_users') || rowSource.includes('Yetki'); if(!isRemoteUser || id.startsWith('local') || id==='current-session'){ const email=String(row?.dataset?.userEmail||row?.querySelector('small')?.textContent?.split('•')?.[0]?.trim()||'').toLowerCase(); saveUsers(loadUsers().filter(u=>String(u.id)!==id && String(u.email).toLowerCase()!==email)); toast('Yerel kullanıcı silindi.'); render(); } else { apiJson('user-delete',{adminToken:sessionToken(),userId:id}).then(()=>refreshUsersPanel()).then(()=>toast('Supabase kullanıcısı silindi.')).catch(err=>toast('Kullanıcı silinemedi: '+err.message)); } return; }
...
window.addEventListener('error', ev=>{ console.error('v2.1.8 hata:', ev.message); const root=document.getElementById('root'); if(root && (root.textContent||'').trim().length<40) root.innerHTML=emergencySafeHtml(ev.message || 'Beklenmeyen site hatası yakalandı.'); });
document.addEventListener('DOMContentLoaded', ()=>{
  ...
  setTimeout(()=>{ const r=document.getElementById('root'); if(!r || (r.textContent||'').trim().length<40) render(); }, 300);
});
window.addEventListener('unhandledrejection', ev=>{ console.error('v2.1.8 promise hata:', ev.reason); const root=document.getElementById('root'); if(root && (root.textContent||'').trim().length<40) root.innerHTML=emergencySafeHtml('Beklenmeyen işlem hatası yakalandı.'); });
