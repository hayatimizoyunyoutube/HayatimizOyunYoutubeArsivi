...
for (const file of jsFiles) {
  ...
  if (file.includes('fix32') && content.includes('return row ? row[1] : (typeof fix12GenreFromTitle')) {
    console.error('FIX32 sonsuz tür döngüsü ana JS içinde devam ediyor:', file);
    process.exit(1);
  }
}
const html = fs.readFileSync(index, 'utf8');
if (!html.includes('hayatimiz-app-fix32.js') || !html.includes('hayatimiz-style-fix32.css')) {
  console.error('dist/index.html FIX32 assetlerini göstermiyor.');
  process.exit(1);
}
console.log('FIX32: Hazır dist kontrolü başarılı.');
console.log('FIX32: Oyun tıklama ve tür üretme sonsuz döngüsü düzeltildi.');
