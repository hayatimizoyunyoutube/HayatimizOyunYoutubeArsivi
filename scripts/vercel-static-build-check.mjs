...
for (const file of jsFiles) {
  ...
  if (!content.includes('HO240F39_INTERNAL_VERSION')) {
    console.error('FIX39 sürükle bırak seri sıralama motoru eksik:', file);
    process.exit(1);
  }
}
const html = fs.readFileSync(index, 'utf8');
if (!html.includes('hayatimiz-app-fix39.js') || !html.includes('hayatimiz-style-fix39.css')) {
  console.error('dist/index.html FIX39 assetlerini göstermiyor.');
  process.exit(1);
}
console.log('FIX39: Hazır dist kontrolü başarılı.');
console.log('FIX39: Seri İzleme sürükle bırak görünür kontrolü başarılı.');
