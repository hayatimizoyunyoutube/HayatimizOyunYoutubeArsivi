...
for (const file of jsFiles) {
  ...
  if (!content.includes('HO240F36_INTERNAL_VERSION')) {
    console.error('FIX36 kapak/seri güvenli motoru eksik:', file);
    process.exit(1);
  }
}
const html = fs.readFileSync(index, 'utf8');
if (!html.includes('hayatimiz-app-fix36.js') || !html.includes('hayatimiz-style-fix36.css')) {
  console.error('dist/index.html FIX36 assetlerini göstermiyor.');
  process.exit(1);
}
console.log('FIX36: Hazır dist kontrolü başarılı.');
console.log('FIX36: Tüm kapaklar ve çıkış tarihi kontrolü başarılı.');
