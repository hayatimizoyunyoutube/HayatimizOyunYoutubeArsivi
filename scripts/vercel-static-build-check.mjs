...
for (const file of jsFiles) {
  ...
  if (!content.includes('HO240F34_INTERNAL_VERSION')) {
    console.error('FIX34 güvenli tür motoru eksik:', file);
    process.exit(1);
  }
}
const html = fs.readFileSync(index, 'utf8');
if (!html.includes('hayatimiz-app-fix34.js') || !html.includes('hayatimiz-style-fix34.css')) {
  console.error('dist/index.html FIX34 assetlerini göstermiyor.');
  process.exit(1);
}
console.log('FIX34: Hazır dist kontrolü başarılı.');
console.log('FIX34: Eski FIX31 cache assetleri dahil oyun tıklama/ekleme stabilizasyonu kontrolü başarılı.');
