-- Hayatımız Oyun v2.1.5 FIX GÜNCELLEME GÜVENLİ TEMİZ BAŞLANGIÇ
...
select 'v2.1.5 FIX guncelleme guvenli kurulum tamam. Veriler silinmedi.' as status;

-- Not: Bu dosya verileri silmez.
