-- Hayatımız Oyun v2.1.5 FIX - Stabil Düzeltme Paketi
...
values ('schema_version', jsonb_build_object('version','v2.1.5 FIX','applied_at', now()), now())
...
select 'Hayatimiz Oyun v2.1.5 FIX schema hazir. GitHub temiz kurulum, Vercel Clear Build Cache ve Supabase schema.sql islemi guncel.' as status;
