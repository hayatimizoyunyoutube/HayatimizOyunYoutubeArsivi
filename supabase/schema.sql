...
values (
  ...
  jsonb_build_object(
    'version','v2.4.9 FIX3',
    'status','Hayatımız Oyun v2.4.9 FIX3 schema hazır. Canlı önizleme ve harf paneli güncellendi.',
    'updated_at',now()
  ),
  now()
)
...
select 'Hayatımız Oyun v2.4.9 FIX3 schema hazır. Canlı önizleme ve harf paneli güncellendi.' as status;
