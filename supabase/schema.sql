...
values (
  ...
  jsonb_build_object(
    'version','v2.4.9 FIX3',
    'status','Hayatımız Oyun v2.4.9 FIX9 schema hazır. RAWG doğru kapak filtresi güncellendi.',
    'updated_at',now()
  ),
  now()
)
...
select 'Hayatımız Oyun v2.4.9 FIX9 schema hazır. RAWG doğru kapak filtresi güncellendi.' as status;
