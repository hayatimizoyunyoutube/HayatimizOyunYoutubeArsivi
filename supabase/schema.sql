...
values (
  ...
  jsonb_build_object(
    'version','v2.4.9 FIX3',
    'status','Hayatımız Oyun v2.4.9 FIX8 schema hazır. Kapak galerisi RAWG ve temizleme araçları eklendi.',
    'updated_at',now()
  ),
  now()
)
...
select 'Hayatımız Oyun v2.4.9 FIX8 schema hazır. Kapak galerisi RAWG ve temizleme araçları eklendi.' as status;
