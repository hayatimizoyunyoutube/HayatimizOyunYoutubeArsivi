...
insert into public.site_settings ("key", value) values
  ('current_version', '{"version":"v2.1.3","name":"Supabase Users Admin Planner"}'::jsonb),
...
select 'Hayatımız Oyun tek Supabase schema hazır' as status, 'v2.1.3-supabase-users-admin-planner' as version;
