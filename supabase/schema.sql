...
-- V2.0.0 - İlk Büyük Güncelleme
-- Loading güvenliği, Admin Panel V2, kapak/hikaye onarım, seri sıralama V2,
-- sosyal ikon sistemi V2 ve RAWG/YouTube stabilizasyon notu.

-- V2.0.0 Fix 1: V2.0.0 geri dönüşünde açılış/güvenli mod sorununu çözen stabil restore notu.
