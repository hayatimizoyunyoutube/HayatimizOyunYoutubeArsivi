...
values (
  ...
  jsonb_build_object(
    'version','v2.4.9 FIX3',
    'status','Hayatımız Oyun v2.4.9 FIX4 schema hazır. Node uyarısı ve puan koruma güncellendi.',
    'updated_at',now()
  ),
  now()
)
...
select 'Hayatımız Oyun v2.4.9 FIX4 schema hazır. Node uyarısı ve puan koruma güncellendi.' as status;
