-- Hayatımız Oyun v2.1.6 - Büyük Arşiv Otomasyonu + Bölüm Yönetimi
...
values ('schema_version', jsonb_build_object('version','v2.1.6','applied_at', now()), now())
...
select 'Hayatimiz Oyun v2.1.6 schema hazir. Playlist bolum importu, site ici seri izleme ve schema_version guncel.' as status;
