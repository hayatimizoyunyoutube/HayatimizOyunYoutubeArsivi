...
values ('schema_version', jsonb_build_object('version','v2.1.6 FIX 3','applied_at', now()), now())
...
select 'Hayatimiz Oyun v2.1.6 FIX 3 schema hazir. Playlist bolum cekme ve seri izleme fixlendi.' as status;
