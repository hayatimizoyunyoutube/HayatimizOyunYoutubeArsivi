-- Hayatımız Oyun v2.1.5.1 Hata Fix + Sürekli Güncellenen Schema
...
values ('schema_version', jsonb_build_object('version','v2.1.5.1','applied_at', now()), now())
...
select 'Hayatimiz Oyun v2.1.3 schema hazir. Sonra GitHub temiz kurulum ve Vercel Clear Build Cache yap.' as status;
...
values ('v2.1.5.1', 'Hata Fix + Sürekli Güncellenen Schema', 'Site açılışındaki firstLetter hatası giderildi; schema.sql tekrar çalıştırıldığında güncelleme notları artık üstüne yazılarak güncellenir.', 'v2.1.5.1 ile alfabetik arşivde eksik fonksiyon kaynaklı beyaz ekran/hata yakalama ekranı düzeltildi. Supabase güncelleme notları için version+title benzersiz indeksi ve upsert mantığı eklendi. schema_version kaydı her çalıştırmada en güncel sürüme çekilir.', 'previews/hayatimiz-oyun-v2151-fix-preview.png', 'published', now())
