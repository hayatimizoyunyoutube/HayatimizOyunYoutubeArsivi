-- Hayatımız Oyun v2.1.6 FIX - Form + Bölüm + Hikaye Düzeltmesi
...
values ('schema_version', jsonb_build_object('version','v2.1.6 FIX','applied_at', now()), now())
...
select 'Hayatimiz Oyun v2.1.6 FIX schema hazir. Form butonlari, hikaye cekme ve playlist bolum importu guncel.' as status;
