...
values (
  ...
  jsonb_build_object(
    'version','v2.4.9 FIX3',
    'status','Hayatımız Oyun v2.5.0 FIX2 schema hazır. Manuel puan stabil düzeltildi.',
    'updated_at',now()
  ),
  now()
)
...
select 'Hayatımız Oyun v2.5.0 FIX2 schema hazır. Manuel puan stabil düzeltildi.' as status;
