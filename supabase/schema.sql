...
values (
  ...
  jsonb_build_object(
    'version','v2.4.9 FIX3',
    'status','Hayatımız Oyun v2.5.0 FIX3 schema hazır. Tek manuel puan paneli eklendi.',
    'updated_at',now()
  ),
  now()
)
...
select 'Hayatımız Oyun v2.5.0 FIX3 schema hazır. Tek manuel puan paneli eklendi.' as status;
