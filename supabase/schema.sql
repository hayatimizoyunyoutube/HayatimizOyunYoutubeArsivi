...
values (
  ...
  jsonb_build_object(
    'version','v2.4.9 FIX3',
    'status','Hayatımız Oyun v2.5.0 schema hazır. Supabase senkronizasyon ve puan seçimi eklendi.',
    'updated_at',now()
  ),
  now()
)
...
select 'Hayatımız Oyun v2.5.0 schema hazır. Supabase senkronizasyon ve puan seçimi eklendi.' as status;
