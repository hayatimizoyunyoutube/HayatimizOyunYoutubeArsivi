...
values (
  ...
  jsonb_build_object(
    'version','v2.4.9 FIX3',
    'status','Hayatımız Oyun v2.4.9 FIX7 schema hazır. DLC yazısı kaldırıldı ve kapak düzeni güncellendi.',
    'updated_at',now()
  ),
  now()
)
...
select 'Hayatımız Oyun v2.4.9 FIX7 schema hazır. DLC yazısı kaldırıldı ve kapak düzeni güncellendi.' as status;
