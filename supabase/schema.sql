-- Hayatımız Oyun v2.1.6 FIX 2 - Hikaye ve Playlist Düzeltmesi
...
values ('schema_version', jsonb_build_object('version','v2.1.6 FIX 2','applied_at', now()), now())
...
select 'Hayatimiz Oyun v2.1.6 FIX 2 schema hazir. RAWG notu hikayeden kaldirildi, playlist videolari bolum listesine temiz cekilir.' as status;
