...
values (
  ...
  jsonb_build_object(
    'version','v2.4.9 FIX3',
    'status','Hayatımız Oyun v2.5.0 FIX1 schema hazır. Güvenli Supabase yenileme eklendi.',
    'updated_at',now()
  ),
  now()
)
...
select 'Hayatımız Oyun v2.5.0 FIX1 schema hazır. Güvenli Supabase yenileme eklendi.' as status;
