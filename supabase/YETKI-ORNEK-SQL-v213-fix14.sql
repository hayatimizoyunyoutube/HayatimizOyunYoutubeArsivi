-- Hayatımız Oyun v2.1.3 Fix 14 yetki örnekleri
...
-- Banla
-- update public.site_users set role = 'banned', is_active = false, banned_at = now(), ban_reason = 'Yönetim tarafından banlandı', updated_at = now() where email = 'MAIL_ADRESINI_BURAYA_YAZ';
