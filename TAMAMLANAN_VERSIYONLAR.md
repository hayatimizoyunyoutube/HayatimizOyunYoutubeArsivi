# FIX64 - Seri Kartları, Bakım Modu ve Paket Temizliği
...
- Devam Eden Seriler alanı artık Yakında/Başlanmamış oyunları göstermez.
- Tamamlanan oyunlarda Kaldığımız Bölüm kartı gösterilmez.
- Seride 1. bölüm izlendiyse sistem sıradaki/kaldığımız bölümü 2. bölüm kabul eder.
- Final hikâye bitti ama seri devam ediyorsa Kalan Görevler ve Toplanacaklar 1. Bölüm mantığı eklendi.
- Listeler sayfası boş kalmayacak şekilde profesyonel liste ekranına çevrildi.
- Topluluk sayfasına Oyun İste ve Hata Bildir girişleri eklendi.
- Üst menü taşması, site adının Ana Sayfa üstüne binmesi ve Topluluk yazısının arama alanına girmesi düzeltildi.
- Bildirim ikonu görünür hale getirildi.
- Bakım modu kullanıcı ekranı ve yönetim paneli profesyonelleştirildi.
- Bakım modu için Kaydet, Aç/Kapat ve Önizle butonları eklendi.
- Yönetim panelindeki Menüyü Kapat / Menüyü Aç butonu stabil hale getirildi.
- Yönetim paneline Kapak/Tarih Kontrol ekranı eklendi.
- Oyun ekle ve düzenleme formlarına Steam Kontrol Et, Kapakları Getir, Çıkış Tarihini Kontrol Et, Tüm Bilgileri Çek ve Playlist Videolarını Çek butonları geri eklendi.
- YouTube playlist çekme işlemi formdaki gerçek playlist URL'sine kilitlendi; kanal/genel oyun videosu karışması azaltıldı.

## Not

Public sürüm v2.4.1 olarak korunur. Paket etiketi FIX63'tür.
...
## v2.4.1 FIX58 - Steam Tarih/Kapak Kontrolü + Playlist Video Fix + Profesyonel Form
- Oyun ekleme formu daha aydınlık, okunabilir ve profesyonel bir stüdyo paneline dönüştürüldü.
- Steam ile Tarih/Kapak Kontrol butonu eklendi; oyun adı, çıkış tarihi ve kapak eşleşmesi kontrol edilir.
- Steam sonucu doğru görünüyorsa tek tıkla kapak ve çıkış tarihi forma uygulanabilir.
- Playlist videolarını çekme sistemi güçlü HTML yedeğiyle desteklendi; bölümler eksik gelirse tekrar tarama yapar.
- Ana istatistiklerde “bölüm” yerine “video” yazacak şekilde düzeltildi.
- Seri izleme ekranında bölüm dili korunur; kullanıcı seriyi izlerken bölüm olarak görür.
- Kullanıcı tarafındaki public sürüm etiketi v2.4.1 olarak korunur, FIX58 sadece geliştirici paket notudur.
- Kontroller: node --check src/main.js, node --check api/index.js ve npm run build başarılı.



## v2.4.1 FIX59 - Kaldığımız Bölüm + Playlist Algılama
- Devam eden serilerde izleyicinin görebileceği **Kaldığımız Bölüm** alanı eklendi.
- Playlistten çekilen video listesine göre son/aktif bölüm otomatik algılanır.
- Ana sayfa devam eden seri kartları, seri kartları ve izleme modalı bu bilgiyi gösterir.
- **Kaldığımız Bölümü İzle** butonu doğrudan ilgili playlist videosunu açar.
- Playlist videosu yoksa sistem manuel bölüm/veri bilgisine güvenli şekilde düşer.
- Public sürüm v2.4.1 olarak korunur, FIX59 geliştirici paket notu olarak tutulur.


## v2.4.1 FIX 60 - Kırmızı Kompakt Arayüz + XP/Level Sıfırlama

- Seçilen referans görsele göre kırmızı/sinematik ana sayfa hazırlandı.
- Devam eden seriler, son videolar ve Kaldığımız Bölüm paneli kompakt düzene taşındı.
- Yönetim paneli güncellendi.
- Yönetim paneline XP / Level sıfırlama ekranı eklendi.

## v2.4.1 FIX61 - 15 Gelecek Güncelleme MD Dosyası

- Eksik olan 15 adet gelecek güncelleme `.md` dosyası eklendi.
- `PLANLANANLAR` klasörü oluşturuldu.
- `GELECEK GÜNCELLEMELER.md` dosyası 15 planı gösterecek şekilde güncellendi.
- Site kodu değiştirilmedi; bu paket planlama/dokümantasyon düzeltmesidir.

## v2.4.1 FIX62 - Schema site_settings Hata Düzeltmesi

- Supabase SQL Editor'da çıkan `relation "site_settings" does not exist` hatası düzeltildi.
- `public.site_settings` uyumluluk tablosu schema içine eklendi.
- Eski FIX bloklarındaki `site_public_version` kayıtları artık hatasız çalışır.
- Mevcut oyun, seri, kapak, playlist, XP/Level ve kullanıcı verileri silinmez.


## v2.4.1 FIX63 - Seri, Bakım, Playlist ve Arama Stabilizasyonu

- Devam eden/yakında/tamamlanan seri ayrımı düzeltildi.
- Kaldığımız Bölüm yalnızca aktif devam eden serilerde gösterilecek hale getirildi.
- Bakım modu, listeler, topluluk, oyun iste, hata bildir ve kapak/tarih kontrol ekranları güçlendirildi.
- Arama kutusunun her harfte odağı kaybetmesi düzeltildi.
- YouTube playlist senkronizasyonu formdaki gerçek playlist linkine kilitlendi.

- FIX65: Oyun ekle / düzenle form kutuları okunabilirlik ve kontrast iyileştirmesi.

- FIX67: Kapak dosyası seçme, büyük kapak galerisi/filtre ve YouTube senkron sonuç tablosu eklendi.

- v2.4.2: Yayın Öncesi Test Merkezi eklendi; eksik kapak, tarih, açıklama, playlist kontrolü ve açılışa hazırlık yüzdesi tamamlandı.

- v2.4.3 - Site Tanıtım ve İlk Kullanım Rehberi: İlk giriş rehberi, yönetim paneli rehber ayarları ve spoiler kontrollü gerçek hikaye açıklaması eklendi.

- v2.4.4 - Mağaza Kaynak Kontrolü, Sosyal Medya ve YouTube Profesyonel Senkronizasyon tamamlandı.

- v2.4.5: Profesyonel oyun ekleme/düzenleme formu, kapak üstü tür/etiket, YouTube tek tablo, bakım modu yenileme, tüm oyunları silme ve form sıfırlama tamamlandı.

- v2.4.6: Seri İzleme Ekranı Geliştirme, profesyonel bakım modu kaydet/aç/kapat sistemi, otomatik son 5 güncelleme notu, Supabase schema güncellemesi ve oynanış ortalama puanı rozeti tamamlandı.

- v2.4.6 FIX1: Seri kartları kompakt/alfabetik yapıldı, tür/etiket rozetleri ayrıldı ve bakım modu kaydet/aç/kapat paneli profesyonelleştirildi.

- v2.4.6 FIX2: Tür/etiket karışması düzeltildi; Steam kullanıcı puanı otomatik forma işlenir hale getirildi.

- v2.4.6 FIX3: Steam puanı bulunamazsa mevcut/eski puan asla kullanılmayacak şekilde düzeltildi.

- v2.4.6 FIX4: schema.sql içinde site_update_notes description kolonu eksik hatası kalıcı olarak düzeltildi.

- v2.4.6 FIX5: Bakım modu Kaydet / Önizle / Bakımı Aç / Bakımı Kapat butonları görünür hale getirildi.

- v2.4.6 FIX7: DLC olan oyun kapaklarına otomatik DLC rozeti eklendi.
...
- v2.4.7 FIX1: Seriler altında oyunlar mini liste olarak görünür hale getirildi.

- v2.4.7 FIX2: Bakım modu Kaydet / Önizle / Bakımı Aç / Bakımı Kapat butonları sabit ve görünür hale getirildi.

- v2.4.7 FIX3: Bakım modu gerçek Kaydet/Aç/Kapat butonları, bağımsız puan çekme ve kayıt uyarıları düzeltildi.

- v2.4.7 FIX4: Bakım Modu için kesin Kaydet / Aç / Kapat sabit işlem paneli eklendi.

- v2.4.7 FIX5: Bakım modu admin ve kullanıcı arayüzü profesyonel hale getirildi.

- v2.4.7 FIX6: Steam Kontrol Et, Steam + Google + Epic Games + Ubisoft puan ortalamasını forma işler.

- v2.4.7 FIX7: Video kapakları, seri alt oyun listesi, canlı puan/YouTube form önizlemesi ve bakım modu Supabase kaydı güçlendirildi.
...
- v2.4.7 FIX11: Videolara alfabetik A-Z şerit ve mevcut oyunlar için Tüm Bilgileri Tekrar Çek / Tümünü Getir işlemi eklendi.

- v2.4.7 FIX12: Videolara alfabetik harf şeridi, Mevcut Oyunlar ekranına görünür tümünü getir paneli ve seri alfabe tıklama düzeltmesi eklendi.

- v2.4.7 FIX13: Kayıtlı oyunları bozan toplu güncelleme kaldırıldı; güvenli kayıtlı oyunları getir paneli ve profesyonel video alfabe başlıkları eklendi.

- v2.4.8 - Profil, Video Alfabe, Seri Harf ve Kapak Çekme Güncellemesi tamamlandı.

- v2.4.9: Mobil/tablet uyumluluk, Tüm Bilgileri Çek kapak önerileri ve Steam kapak önizleme sistemi tamamlandı.

- v2.4.9 FIX1: Profesyonel harf paneli, canlı kapak önizleme, YouTube kart görünümü ve schema versiyon düzeltmesi tamamlandı.

- v2.4.9 FIX2: Supabase schema status alanındaki eski v2.4.4 mesajı son sürümle değiştirildi.

- v2.4.9 FIX3: Canlı önizleme ve seriler/videolar profesyonel Harfe Git paneli düzeltildi.

- v2.4.9 FIX4: Vercel Node engines uyarısı giderildi; kapak/Steam/Tüm Bilgileri Çek işlemlerinde puan sıfırlanması engellendi.

- v2.4.9 FIX5: Vercel Node uyarısı için package.json engines alanı kaldırıldı; Project Settings Node 24.x kullanılacak.

- v2.4.9 FIX6: Seriler ve videolar Harfe Git paneli kesin olarak profesyonel A-B-C-D chip düzenine alındı.

- v2.4.9 FIX7: DLC yazıları kaldırıldı; seri içi kapak ve oyun listesi düzenlendi.
...
- v2.5.0 FIX1: Supabase Verilerini Yenile güvenli hale getirildi; eksik veri gelirse kapak/seri kayıtları korunur.

- v2.5.0 FIX2: Manuel puan yazma alanı stabil hale getirildi; kapak/Steam/kaydet işlemlerinde manuel puan korunur.

- v2.5.0 FIX3: Çift manuel puan panelleri kaldırıldı; tek yazılabilir manuel puan paneli eklendi.

- v2.5.1: Güncelleme Notları Merkezi tamamlandı; kullanıcı modalı/sayfası ve admin not yönetimi eklendi.

- v2.5.2 Plan: Bildirim ve Duyuru Merkezi.

- v2.5.1 FIX1: Bakım modu, güncelleme notları, manuel puan ve seri sıralaması Supabase’e kalıcı kaydedilecek şekilde düzeltildi.

- v2.5.1 FIX2: Yönetim paneli stabil hale getirildi; otomatik paneller ve karışan click yakalayıcıları temizlendi.

- v2.5.3 Plan: Admin Panel Temizlik ve Veri Kurtarma Merkezi.

- v2.5.2 FIX1: Yönetim panelinde karışan güncelleme/bildirim panelleri temizlendi; bakım modu güncelleme notları son sürüme bağlandı.

- v2.5.2 FIX2: Güncelleme Notları devre dışı bırakılmadan, ayrı stabil panel olarak yeniden aktif edildi.

- v2.5.2 FIX3: Videolar sayfasındaki İzle butonları tüm kart/link tiplerinde stabil çalışacak şekilde düzeltildi.

- v2.5.2 FIX4: Supabase schema içinde site_notifications UUID id hatası düzeltildi.

- v2.5.2 FIX5: Güncelleme notları ana sayfadan kaldırıldı; videolar site içi player ekranında tek kez açılacak şekilde düzeltildi.

- v2.5.2 FIX6: Çift görünen bildirim ikonları temizlendi; sadece üst menüde tek bildirim ikonu kalır.

- v2.5.2 FIX7: Yönetim panelindeki tekrarlanan paneller/buton karmaşası temizlendi; bakım notları güncel sürümlere bağlandı.
...
- v2.5.2 FIX12: Final temiz panel, seri sıralama, Duyuru Merkezi, Güncelleme Notları ve kalıcı bakım modu düzeltildi.

- v2.5.2 FIX13: Seri sıralama kullanıcı tarafına doğru yansıtıldı, yeni kullanıcı kaydı Supabase site_users tablosuna bağlandı ve eski karışan panel katmanları temizlendi.

- v2.5.3 FIX1: Bakım Modu ve Güncelleme Notları stabil hale getirildi; settings-set API maintenance_mode değerini artık yanlışlıkla ezmez.

- v2.5.3 FIX2: Bakım modu, yayın takvimi ve güncelleme notları stabil hale getirildi; planlanan güncellemeler v3.0.0’a kadar eklendi.

- v2.5.3 FIX3: Tam stabil bakım, yayın takvimi, güncelleme notları ve panel temizliği yapıldı.

- v2.5.3 FIX4: Yayın Takvimi otomatik üretim kapatıldı; manuel etkinlik formu, canlı önizleme ve puan Uygula düzeltmesi eklendi.

- v2.5.4 FIX2: Güncelleme Notları ve Yayın Takvimi boş sayfa kesin fix uygulandı.

- v2.5.4 FIX3: Açılış öncesi son kontrol; boş sayfa koruması ve direkt URL önceliği düzeltildi.

- v2.5.4 FIX4: Admin takvim, bakım modu ve güncelleme notları final fix uygulandı.

- v2.5.4 FIX5: Takvim kapak/tür çekme, Güncelleme Notları CRUD ve geri tuşu fix uygulandı.
...
- v2.5.4 FIX8: Butonlar temiz admin final fix uygulandı.

- v2.5.4 FIX9: Bakım Modu tıklama, görünür sürüm ve Supabase ultra fast SQL düzeltildi.
