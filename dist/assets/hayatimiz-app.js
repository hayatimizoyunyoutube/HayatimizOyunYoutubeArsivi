...
const FIX_NAME = 'v4.0.0 - Not Defteriyle Supabase Oyun Ekleme';
const RELEASE_TAG = 'v4.0.0-NOT-DEFTERI-SUPABASE-FIX';
...
Hikaye: Bond, ilk resmi saha görevinde uluslararası bir tehdidin izini sürerken hem düşmanlarıyla hem de kendi kararlarıyla yüzleşir.
---
...
function noteFieldSet(obj, key, val){
  ...
  else if(['steam','steamappid','appid'].includes(k)) obj.steamAppId=v;
}
