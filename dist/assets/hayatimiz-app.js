...
async function syncPlaylistForForm(form){
  ...
  if(!result.episodes.length){
    ...
    if(box) box.innerHTML='<b>Gerçek bölüm çekilemedi.</b> YouTube API anahtarı veya playlist erişimi kontrol edilmeli; sahte bölüm oluşturulmadı, mevcut liste korunur.';
