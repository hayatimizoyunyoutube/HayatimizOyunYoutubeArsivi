AI Düzenle Öneri + Kategori Fix kurulum özeti
1. Bu paket yeni sürüm değil, fix paketidir.
2. Temiz kurulum yöntemini kullan.
3. .git klasörü korunur, eski dosyalar temizlenir, ZIP içeriği proje klasörüne çıkarılır.
4. GitHub force push yapılır.
5. Vercel Redeploy yaparken Clear Build Cache seçilir.
6. Bu fix için yeni Supabase tablo zorunluluğu yoktur; mevcut site_features ve site_admin_planner tablolarını kullanır.
