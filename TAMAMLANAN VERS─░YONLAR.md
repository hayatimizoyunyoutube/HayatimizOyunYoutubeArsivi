...
# v2.2.5 FIX 1 - Hızlı Deploy
- Vercel deploy uzun sürmesin diye prebuilt dist pakete dahil edildi.
- vercel.json install/build adımlarını atlayacak şekilde düzenlendi.
- outputDirectory dist olarak sabitlendi.
- .vercelignore dosyası dist klasörünü artık dışlamaz.
- VERCEL-HIZLI-DEPLOY-NOTU.txt eklendi.
