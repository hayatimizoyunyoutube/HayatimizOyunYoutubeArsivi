## Son FIX Notu
- v2.1.2 FIX: Üst menü yazı taşması profesyonel kapsül menüyle düzeltildi. Yazılar kısaltılmadan korunur; dar ekranda menü kendi içinde güvenli kayar. Schema gerekli değil.
...
## ✅ Son FIX Notu - v2.1.2 Üst Menü Tek Satır
- Yeni sürüm yapılmadı.
- Üst menü butonlarının alta taşması düzeltildi.
- 15 plan kuralı korunuyor.
- Schema gerekli değil.
